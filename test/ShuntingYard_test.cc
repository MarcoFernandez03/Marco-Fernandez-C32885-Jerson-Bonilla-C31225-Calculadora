...
Token token(TokenType::TOKEN_TYPE_NUMBER, '3');
    ...
    EXPECT_EQ(tokenizedStack.size(), 3);    
}
...
TEST(ParseTest, MediumExpression){
    ...
    stack<Token> tokenizedStack = sy.parse(tokenStack);
    EXPECT_EQ(tokenizedStack.size(), 9);    
}

TEST(ParseTest, BadOperatorPosition){
    ShuntingYard sy;
    stack<Token> tokenStack;
    Token token(TokenType::TOKEN_TYPE_NUMBER, '3');
    tokenStack.push(token);
...
TEST(ParseTest, BadNumberPosition){
    ShuntingYard sy;
    stack<Token> tokenStack;
    Token token(TokenType::TOKEN_TYPE_NUMBER, '3');
    tokenStack.push(token);
...
TEST(ParseTest, BadLParenthesisPosition){
    ShuntingYard sy;
    stack<Token> tokenStack;
    Token token(TokenType::TOKEN_TYPE_NUMBER, '3');
    tokenStack.push(token);
...
TEST(ParseTest, BadRParenthesisPosition){
    ShuntingYard sy;
    stack<Token> tokenStack;
    Token token(TokenType::TOKEN_TYPE_NUMBER, '3');
    tokenStack.push(token);
...
Token token14(TokenType::TOKEN_TYPE_NUMBER, '3');
    tokenStack.push(token14);
    stack<Token> tokenizedStack = sy.parse(tokenStack);
    EXPECT_EQ(tokenizedStack.size(), 13);    
}
